...
%% Space-saving adjustments (Aggressive)
\setlength{\tabcolsep}{2pt}           % Tighter table columns
...
\title{DeepVis: Visualizing File System State for Deep Anomaly Detection at Cloud Scale}
