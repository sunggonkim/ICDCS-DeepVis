...
Our evaluation results show that \DeepVis improves verification throughput by 5.5$\times$ compared with traditional integrity monitors, while maintaining 97.1\% recall on active threats with a 0.3\% false positive rate and negligible runtime overhead (CPU impact $<2\%$).
\end{abstract}
