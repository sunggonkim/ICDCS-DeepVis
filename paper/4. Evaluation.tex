...
\begin{figure}[t]
    ...
    \caption{\textbf{Real Multi-Workload Fleet vs. Stealthy Attack.} (a) Aggregated error distribution from 5 real workloads maintains stability (Blue Area), with the attack appearing as a distinct outlier (Red Star). (b) Analysis of alert sources shows AIDE generates 180 false alerts (Bastion + Fleet Ops), whereas DeepVis achieves zero false alerts while successfully detecting the threat.}
