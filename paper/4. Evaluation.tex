...
\begin{table}[t]
\centering
\caption{Resolution Scaling: Trade-offs (4 OS averaged, 30 trials each)}
\label{tab:resolution_ablation}
\begin{tabular}{lcccccc}
\toprule
\textbf{Res.} & \textbf{Pixels} & \textbf{Collision} & \textbf{FPR} & \textbf{Recall} & \textbf{Time} & \textbf{Model} \\
\midrule
64$\times$64 & 4K & 20.5\% & 3.3\% & 100\% & 6.1ms & 0.1 MB \\
128$\times$128 & 16K & 6.1\% & 4.2\% & 100\% & 4.9ms & 0.5 MB \\
256$\times$256 & 65K & 1.6\% & 8.3\% & 100\% & 4.9ms & 2.0 MB \\
512$\times$512 & 262K & \textbf{0.4\%} & 2.5\% & 100\% & 5.0ms & 8.0 MB \\
\bottomrule
\end{tabular}
\end{table}
