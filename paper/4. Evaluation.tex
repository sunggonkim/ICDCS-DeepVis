...
\begin{table}[t]
\centering
\caption{\textbf{Unified Detection Performance.} Comparison of \DeepVis against Tuned Baselines across four platforms. While ClamAV (Tuned with known hashes) sets a theoretical upper bound, \DeepVis achieves comparable or superior recall on Linux/Mobile/Web threats via unsupervised learning, with significantly lower false positives (0.3\%) than heuristic rules (YARA: 31.0\%).}
