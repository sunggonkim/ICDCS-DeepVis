...
\begin{table}[t]
\centering
\caption{\textbf{Detection Accuracy (RQ1).} DeepVis detects 15/16 scenarios, successfully flagging binaries and hidden scripts, but failing on public-facing webshells (c99.php).}
...
\begin{table}[t]
\centering
\caption{\textbf{Unified Detection Performance.} Verified on GCP \texttt{deepvis-mid}. DeepVis achieves 100\% recall with 0\% FP, ensuring reliability amidst system churn.}
