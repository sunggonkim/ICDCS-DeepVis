...
\begin{table}[t]
\centering
\caption{\textbf{Unified Detection Performance (37,571 Files).} Simplified view emphasizing Selectivity. \DeepVis triggers fewer alerts (230) than YARA (1,024) while correctly isolating binary threats (96\% Recall).}
\label{tab:unified_detection}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{l cc cc l}
\toprule
\multirow{2}{*}{\textbf{System}} & \multicolumn{2}{c}{\textbf{Global Selectivity}} & \multicolumn{2}{c}{\textbf{Threat Recall (\%)}} & \multicolumn{1}{c}{\textbf{False Positive}} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-6}
& \textbf{Alerts (Count)} & \textbf{Repo Rate} & \textbf{Binary} & \textbf{Script} & \textbf{Primary Source} \\
\midrule
ClamAV & 0 & 0.0\% & 33 & 0 & - \\
YARA & 1,024 & 2.7\% & 100 & 100 & Source Code (Text) \\
AIDE & 37,571 & 100.0\% & 100 & 100 & System Updates \\
Falco & 38 & 0.1\% & 100 & 0 & Legal Integ. Updates \\
Set-AE & 1,878 & 5.0\% & 40 & 0 & System Libs \\
Entropy-Only & $\sim$3,800 & 10.2\% & 25 & 10 & Normal Binaries \\
\midrule
\rowcolor{gray!10} 
\textbf{DeepVis} & \textbf{230} & \textbf{0.6\%} & \textbf{96} & 0 & Admin Tools (High Entropy) \\
\bottomrule
\end{tabular}%
}
\end{table}
