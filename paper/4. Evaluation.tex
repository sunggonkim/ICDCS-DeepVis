...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{Figures/fig_sosp_overhead.pdf}
\caption{Time-series analysis of system overhead under fixed 2000 IOPS load. (a) I/O Completion Latency: AIDE exhibits the highest latency spikes due to blocking \texttt{SHA256} full-file reads. (b) Global CPU Usage: AIDE and Osquery exhibit periodic 100\% CPU saturation, while DeepVis maintains near-Baseline levels.}
