...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Operational Efficiency:} Figure~\ref{fig:churn_alerts} highlights the impact on SOC operations. AIDE generated \textbf{501 alerts} (500 updates + 1 threat), overwhelming analysts. DeepVis generated \textbf{0 false alerts} during the update window and correctly flagged only the single threat, eliminating alert fatigue.
\end{itemize}
