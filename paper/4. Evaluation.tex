...
\begin{table}[t]
\centering
\caption{Rust Scanner Performance (io\_uring + rayon)}
\label{tab:rust}
\begin{tabular}{lccc}
\toprule
\textbf{Files} & \textbf{Scan (ms)} & \textbf{Entropy (ms)} & \textbf{Throughput} \\
\midrule
1,000 & 3.3 & 5.2 & 118,063 f/s \\
10,000 & 32.5 & 14.4 & 213,317 f/s \\
50,000 & 157.6 & 75.4 & 214,528 f/s \\
100,000 & 311.5 & 125.2 & 228,976 f/s \\
200,000 & 526.5 & 237.2 & \textbf{261,871 f/s} \\
\bottomrule
\end{tabular}
\end{table}

\noindent At \textbf{261K files/sec}, a 100K-file container verifies in 0.4 seconds, and a 500K-file server in 1.9 seconds. This is \textbf{1,100$\times$ faster} than sequential \texttt{stat()} calls.
