...
LKM Rootkit & \texttt{Diamorphine} & 0.59 & \textbf{0.60} & \textbf{1.00} & Det. \\
LD\_PRELOAD & \texttt{Azazel} & 0.59 & \textbf{0.60} & 0.00 & Det. \\
LD\_PRELOAD & \texttt{beurk} & 0.62 & \textbf{0.60} & 0.00 & Det. \\
...
Interpreter & \texttt{python3} & 0.65 & 0.00 & 0.00 & Clean \\
Library & \texttt{libc.so.6} & 0.64 & 0.00 & 0.00 & Clean \\
...
Admin Tool & \texttt{snap} & \textbf{0.78} & 0.00 & 0.00 & False Pos. \\
\bottomrule
\end{tabular}
}
\end{table}
