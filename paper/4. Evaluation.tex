...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Result:} As shown in Figure~\ref{fig:churn_hist}, the clusters reflect the multi-channel anomaly score ($L_\infty$). Even with 8,500 modifications, benign operations remain strictly below the anomaly threshold. In contrast, all 5 rootkits (Red Stars) reach the absolute score of \textbf{1.0} via G/B-channel overrides.
