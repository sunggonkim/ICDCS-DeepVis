...
\midrule
ClamAV$^\dagger$ & 33.0\% & N/A & N/A & N/A & 0.0\% \\
YARA$^\dagger$ & 100.0\% & N/A & N/A & N/A & 45.0\% \\
AIDE$^\dagger$ & 100.0\% & N/A & N/A & N/A & 100.0\% \\
Set-AE & 40.0\% & - & - & - & 5.0\% \\
\midrule
DeepVis (Ent.) & 25.0\% & 63.0\% & 67.7\% & 93.5\% & 10.2\% \\
\rowcolor{gray!10} 
\textbf{DeepVis (Full)} & \textbf{97.1\%} & \textbf{15.8\%} & \textbf{89.6\%} & \textbf{100.0\%} & \textbf{0.3\%} \\
\bottomrule
\multicolumn{6}{l}{\scriptsize $^\dagger$Ref. points evaluated on Linux. (N/A: Not evaluated on this testbed).}
\end{tabular}%
}
\end{table}
