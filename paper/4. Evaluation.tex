...
\begin{enumerate}
    ...
    \item \textbf{Detection:} 100\% recall on 10 rootkit families (1,000 samples) with $L_\infty \approx 0.65$ vs. $\tau = 0.513$.
    \item \textbf{Cross-OS:} Zero-shot transfer to CentOS/Debian with 0\% FPR, 100\% recall.
    \item \textbf{Adversarial:} 75\% detection rate (300/400); \textbf{Low-Entropy Mimicry achieves complete evasion}---a critical limitation.
