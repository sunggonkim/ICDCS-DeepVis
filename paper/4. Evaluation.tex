...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\linewidth]{Figures/fig_header_sensitivity_extended.pdf} 
    \caption{\textbf{Extended Header Sensitivity (Page-Aligned Sampling).} Throughput remains stable ($\approx 28\text{--}33$k/s) up to 4KB, confirming that \DeepVis efficiently leverages OS Page Cache prefetching. Significant I/O degradation begins at 8KB+ (Multi-Page Reads), validating the 4KB-aligned ingestion strategy as the optimal throughput boundary.}
