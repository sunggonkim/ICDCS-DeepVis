...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/fig_header_sensitivity.pdf} 
    \caption{\textbf{Header Size Sensitivity.} Verified with Cold Cache I/O. Throughput drops significantly ($28$k/s) for headers $>512$B due to I/O bottlenecks. The range 64--128B represents the optimal trade-off, achieving maximum throughput ($\approx 33$k/s) while capturing sufficient entropy for high F1-scores ($>$0.9).}
