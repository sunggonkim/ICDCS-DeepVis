...
\begin{figure}[t]
    ...
    \caption{\textbf{Effect of Scan Granularity (Page-Aligned Sampling).} While detection accuracy ($F_1$-score) saturates at $\approx$96B, throughput remains stable up to 4KB due to OS page prefetching. We therefore adopt a \textbf{4KB Page-Aligned Sampling} strategy, maximizing feature extraction without incurring additional I/O penalty compared to smaller headers. Throughput degradation begins at 8KB+ due to multi-page I/O.}
