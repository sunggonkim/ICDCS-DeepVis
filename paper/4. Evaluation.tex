...
\noindent
\textbf{Recommendation.} We recommend \textbf{128$\times$128} as the default for container-based deployments, with dynamic scaling to 256$\times$256 when file count exceeds 3,000.
