...
\midrule
\textbf{DeepVis} & 40,000/s & 1.0$\times$ & Async (\texttt{io\_uring}) \\
AIDE-Header & 8,000/s & 5.0$\times$ slower & Sync (SHA256) \\
ClamAV-Header & 5,000/s & 8.0$\times$ slower & Sync (Pattern Match) \\
ssdeep-Header & 3,500/s & 11.4$\times$ slower & Sync (Rolling Hash) \\
\bottomrule
\end{tabular}%
}
\end{table}
