...
Entropy-Only & 10.2 & 25 & 10 & 10 & 0 & 90 & 100 & 100 \\
\midrule
\rowcolor{gray!10} 
\textbf{DeepVis} & \textbf{0.6} & \textbf{96} & \textbf{100} & \textbf{100} & 0 & \textbf{0} & \textbf{0} & 100 \\
\bottomrule
\multicolumn{9}{l}{\footnotesize * Repo Rate: Global flag rate. Entropy-Only fails (25\% Acc), while DeepVis achieves 96\% via context fusion.} \\
\end{tabular}%
}
\end{table}
