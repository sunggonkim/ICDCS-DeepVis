...
\vspace{-0.6cm} % Tighten legend gap
\subfloat[Scalability]{
    \includegraphics[width=0.45\columnwidth]{Figures/fig_motivation_a.pdf}
}
\hspace{0.02\columnwidth}
\subfloat[Alert Fatigue]{
    \includegraphics[width=0.45\columnwidth]{Figures/fig_motivation_b.pdf}
}
\vspace{-0.2cm}
\caption{DeepVis vs. AIDE: (a) scalability and (b) precision.}
