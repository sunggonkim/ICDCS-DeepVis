...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{Figures/fig_motivation_legend.pdf}
\vspace{-1.0cm} % Pull graphs up to legend
\\
...
\vspace{2mm} % Ensure main caption is strictly below sub-labels
