...
Deep learning methods such as Set-AE~\cite{zaheer2017deepsets} provide lightweight set-based anomaly detection models but they can struggle with extreme-scale file corruption scenarios, where single critical modifications dilute within vast benign datasets. 
