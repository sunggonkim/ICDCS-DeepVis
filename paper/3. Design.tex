...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/entropy_byte_patterns.pdf}
    \caption{Entropy-based analysis and byte patterns. (a) Text files use limited ASCII range with high redundancy. (b) ELF binaries show structured headers and code patterns. (c) Encrypted rootkits exhibit uniform byte distribution---the ``Attacker's Paradox'': hiding creates a detectable anomaly.}
