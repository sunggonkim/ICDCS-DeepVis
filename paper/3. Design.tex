...
\noindent\textbf{Snapshot Engine:} 3,200 lines C++, built on \texttt{liburing} v2.3.

\noindent\textbf{Tensor Generator:} 800 lines Python/NumPy with \texttt{hashlib.sha256}.

\noindent\textbf{Inference:} ONNX Runtime 1.16, INT8 quantization. Cold-start: 12ms. Inference: 3.15ms.

\noindent\textbf{Deployment:} Kubernetes DaemonSet sidecar. Limits: 0.5 vCPU, 128 MB RAM.
