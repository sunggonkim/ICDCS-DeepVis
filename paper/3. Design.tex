...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/entropy_explanation.pdf}
    \caption{Byte value distributions for different file types. Text files concentrate in the ASCII range (a). ELF binaries show structure with null padding (b). Encrypted rootkits exhibit near-uniform distribution (c)---a detectable anomaly.}
