...
Figure~\ref{fig:overall} shows the overall procedure of \DeepVis. \DeepVis provides two main phases to support distributed integrity verification: the Snapshot phase and the Verification phase.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=7cm]{Figures/Design/io_Arch.pdf}
    \caption{\textbf{Hybrid Snapshot Pipeline.} Rayon parallel path collection feeds \texttt{io\_uring} async I/O.}
    \label{fig:pipeline}
\end{figure}
...
\begin{figure}[t]
    ...
    \caption{\textbf{Shift Invariance.} Hash-based mapping preserves pixel stability on file insertion, unlike ordered approaches.}
    \label{fig:hash}
\end{figure}
