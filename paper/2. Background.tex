...
\begin{figure*}[!htb]
    \centering
    \subfloat[Entropy Distribution]{
        \includegraphics[width=0.24\textwidth]{figures/entropy_real_analysis.pdf}
        \label{fig:entropy_hist}
    }
    \hfill
    \subfloat[Text File (H $\approx$ 4.2)]{
        \includegraphics[width=0.24\textwidth]{figures/Background_entrophy/Background_Normal_text.pdf}
        \label{fig:entropy_text}
    }
    \hfill
    \subfloat[ELF Binary (H $\approx$ 6.1)]{
        \includegraphics[width=0.24\textwidth]{figures/Background_entrophy/Background_System_binaray.pdf}
        \label{fig:entropy_elf}
    }
    \hfill
    \subfloat[Rootkit (H $\approx$ 7.9)]{
        \includegraphics[width=0.24\textwidth]{figures/Background_entrophy/Background_Rootkit.pdf}
